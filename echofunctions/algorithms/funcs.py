...
# volumes, x1, y1, x2, y2 = calculateVolumeMainAxisBottomShift("/Users/ishan/Downloads/Boundary.png", 20, 1, "Method of Disks")
...
#     longLine1stCoords = (int(x1[0][coord]), int(y1[0][coord]))
#     longLine2ndCoords = (int(x2[0][coord]), int(y2[0][coord]))
#   else: # draws the parallel lines
#     cv2.line(image, (int(x1[0][coord]), int(y1[0][coord])), (int(x2[0][coord]), int(y2[0][coord])), (255, 255, 255), 1)
  
#   cv2.line(image, longLine1stCoords, longLine2ndCoords, (255, 255, 255), 1) # Drawing the perpendicular/long line in different color

# cv2.imwrite("/Users/ishan/Downloads/algo-Traced.png", image)